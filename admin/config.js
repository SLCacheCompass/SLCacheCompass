...
window.addEventListener('load', () => {
  for (const src of ['operations.js', 'capacity-approvals.js', 'issue-guard.js', 'release-upload.js?v=20260905-2', 'manual-issue-fix.js', 'purge-feedback.js', 'table-tools.js?v=20260913-1']) {
